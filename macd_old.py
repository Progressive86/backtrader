...
# if dataset is None, args.data has been given
    data = bt.feeds.BacktraderCSVData(dataname=())
    cerebro = bt.Cerebro()
...
def runstrat(args=None):
    ...
    # if dataset is None, args.data has been given
    dataname = dataname(args.dataset, args.data) #dataset or dataname/path needs to be included here
...
def parse_args(pargs=None):
    ...
    group1.add_argument('--dataset', required=False, action='store',
                        default=None, choices=(), #dataset or dataname/path needs to be included here
